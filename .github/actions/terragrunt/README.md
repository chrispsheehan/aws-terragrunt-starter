...
When a workflow chooses to persist a per-stack saved plan produced by this
action, the Terragrunt stack or module artifact typically contains:
  ...
  read-outputs:
    ...
    steps:
      ...
      - name: Read Terragrunt outputs
        ...
        with:
          tg_directory: infra/live/dev/aws/migrations
          tg_action: init
  ...
  apply:
    ...
    steps:
      ...
      - name: Apply infrastructure
        uses: ./.github/actions/terragrunt
        with:
          tg_directory: infra/live/dev/aws/security
          tg_action: apply
  ...
  apply:
    ...
    steps:
      ...
      - name: Download saved plan
        ...
        with:
          name: terragrunt-plan-dev-security
          path: infra/live/dev/aws/security
